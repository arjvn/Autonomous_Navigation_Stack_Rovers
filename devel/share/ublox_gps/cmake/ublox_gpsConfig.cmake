...
if("TRUE" STREQUAL "TRUE")
  set(ublox_gps_SOURCE_PREFIX /home/arc/groot_ws/src/ublox_f9p/ublox_gps)
  set(ublox_gps_DEVEL_PREFIX /home/arc/groot_ws/devel)
  ...
  set(ublox_gps_INSTALL_PREFIX /home/arc/groot_ws/install)
...
if(NOT "/home/arc/groot_ws/src/ublox_f9p/ublox_gps/include " STREQUAL " ")
  set(ublox_gps_INCLUDE_DIRS "")
  set(_include_dirs "/home/arc/groot_ws/src/ublox_f9p/ublox_gps/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ublox_gps' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arc/groot_ws/src/ublox_f9p/ublox_gps/${idir}'.  ${_report}")
    endif()
