...
if("TRUE" STREQUAL "TRUE")
  set(imu_filter_madgwick_SOURCE_PREFIX /home/arc/groot_ws/src/imu_tools/imu_filter_madgwick)
  set(imu_filter_madgwick_DEVEL_PREFIX /home/arc/groot_ws/devel)
  ...
  set(imu_filter_madgwick_INSTALL_PREFIX /home/arc/groot_ws/install)
...
if(NOT "/home/arc/groot_ws/devel/include;/usr/include " STREQUAL " ")
  set(imu_filter_madgwick_INCLUDE_DIRS "")
  set(_include_dirs "/home/arc/groot_ws/devel/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_filter_madgwick' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arc/groot_ws/src/imu_tools/imu_filter_madgwick/${idir}'.  ${_report}")
    endif()
    _list_append_unique(imu_filter_madgwick_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "imu_filter;imu_filter_nodelet;/usr/lib/aarch64-linux-gnu/libboost_system.so;/usr/lib/aarch64-linux-gnu/libboost_thread.so;-lpthread;/usr/lib/aarch64-linux-gnu/libboost_chrono.so;/usr/lib/aarch64-linux-gnu/libboost_date_time.so;/usr/lib/aarch64-linux-gnu/libboost_atomic.so")
