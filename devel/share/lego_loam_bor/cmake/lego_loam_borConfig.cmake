...
if(lego_loam_bor_CONFIG_INCLUDED)
  return()
endif()
set(lego_loam_bor_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(lego_loam_bor_SOURCE_PREFIX /home/arc/groot_ws/src/LeGO-LOAM-BOR/LeGO-LOAM)
  set(lego_loam_bor_DEVEL_PREFIX /home/arc/groot_ws/devel)
  set(lego_loam_bor_INSTALL_PREFIX "")
  set(lego_loam_bor_PREFIX ${lego_loam_bor_DEVEL_PREFIX})
else()
  set(lego_loam_bor_SOURCE_PREFIX "")
  set(lego_loam_bor_DEVEL_PREFIX "")
  set(lego_loam_bor_INSTALL_PREFIX /home/arc/groot_ws/install)
  set(lego_loam_bor_PREFIX ${lego_loam_bor_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'lego_loam_bor' is deprecated")
...
set(lego_loam_bor_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/arc/groot_ws/src/LeGO-LOAM-BOR/LeGO-LOAM/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/aarch64-linux-gnu/openmpi/include/openmpi;/usr/lib/aarch64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/aarch64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/aarch64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/aarch64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  set(lego_loam_bor_INCLUDE_DIRS "")
  set(_include_dirs "/home/arc/groot_ws/src/LeGO-LOAM-BOR/LeGO-LOAM/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/aarch64-linux-gnu/openmpi/include/openmpi;/usr/lib/aarch64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/aarch64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/aarch64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/aarch64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND lego_loam_bor_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/arc/groot_ws/devel/lib;/home/arc/groot_ws/devel/lib;/home/arc/unit3_ws/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(lego_loam_bor_LIBRARY_DIRS ${lib_path})
      list(APPEND lego_loam_bor_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'lego_loam_bor'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND lego_loam_bor_LIBRARIES ${lib})
    endif()
  endif()
...
set(lego_loam_bor_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${lego_loam_bor_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "cloud_msgs;rosbag_storage")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 lego_loam_bor_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${lego_loam_bor_dep}_FOUND)
      find_package(${lego_loam_bor_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${lego_loam_bor_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(lego_loam_bor_INCLUDE_DIRS ${${lego_loam_bor_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(lego_loam_bor_LIBRARIES ${lego_loam_bor_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${lego_loam_bor_dep}_LIBRARIES})
  _list_append_deduplicate(lego_loam_bor_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(lego_loam_bor_LIBRARIES ${lego_loam_bor_LIBRARIES})

  _list_append_unique(lego_loam_bor_LIBRARY_DIRS ${${lego_loam_bor_dep}_LIBRARY_DIRS})
  list(APPEND lego_loam_bor_EXPORTED_TARGETS ${${lego_loam_bor_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${lego_loam_bor_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
