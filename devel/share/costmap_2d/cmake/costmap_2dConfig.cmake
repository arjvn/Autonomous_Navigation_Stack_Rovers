...
if("TRUE" STREQUAL "TRUE")
  set(costmap_2d_SOURCE_PREFIX /home/arc/groot_ws/src/navigation/costmap_2d)
  set(costmap_2d_DEVEL_PREFIX /home/arc/groot_ws/devel)
  ...
  set(costmap_2d_INSTALL_PREFIX /home/arc/groot_ws/install)
...
if(NOT "/home/arc/groot_ws/devel/include;/home/arc/groot_ws/src/navigation/costmap_2d/include;/usr/include/eigen3;/usr/include " STREQUAL " ")
  set(costmap_2d_INCLUDE_DIRS "")
  set(_include_dirs "/home/arc/groot_ws/devel/include;/home/arc/groot_ws/src/navigation/costmap_2d/include;/usr/include/eigen3;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'costmap_2d' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arc/groot_ws/src/navigation/costmap_2d/${idir}'.  ${_report}")
    endif()
    _list_append_unique(costmap_2d_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "costmap_2d;layers;/usr/lib/aarch64-linux-gnu/libboost_system.so;/usr/lib/aarch64-linux-gnu/libboost_thread.so;-lpthread;/usr/lib/aarch64-linux-gnu/libboost_chrono.so;/usr/lib/aarch64-linux-gnu/libboost_date_time.so;/usr/lib/aarch64-linux-gnu/libboost_atomic.so")
