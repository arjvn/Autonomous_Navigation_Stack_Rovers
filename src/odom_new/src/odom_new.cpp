...
int main(int argc, char** argv){
  ...
  while(n.ok()){
    ...
    double r_min;
    if (Right_wheel1 <= Right_wheel2 && Right_wheel1<=Right_wheel3) {
      r_min = Right_wheel1;
    }
    if (Right_wheel2 <= Right_wheel1 && Right_wheel2<=Right_wheel3) {
      r_min = Right_wheel2;
    }
    if (Right_wheel3 <= Right_wheel2 && Right_wheel3<=Right_wheel1) {
      r_min = Right_wheel3;
    }
    ...
    double r_side;
    double l_side;
    if (Right_wheel1>= ((100+threshold)/100*r_min)) {
        Right_wheel1 =0;
    }
    if (Right_wheel2>= ((100+threshold)/100*r_min)) {
        Right_wheel2 =0;
    }
    if (Right_wheel3>= ((100+threshold)/100*r_min)) {
        Right_wheel3 =0;
    }
    double r_total = Right_wheel1 + Right_wheel2 + Right_wheel3;
    int count=3;
    if (Right_wheel1==0){
        count = count-1;
    }
    ...
    if (count ==0) {
        ...
        r_side = (r_total/count);
    }

    double l_min; 
    if (Left_wheel1 <= Left_wheel2 && Left_wheel1<=Left_wheel3) {
      l_min = Left_wheel1;
    }
    if (Left_wheel2 <= Left_wheel1 && Left_wheel2<=Left_wheel3) {
      l_min = Left_wheel2;
    }
    if (Left_wheel3 <= Left_wheel2 && Left_wheel3<=Left_wheel1) {
      l_min = Left_wheel3;
    }
    
    if (Left_wheel1>= ((100+threshold)/100*l_min)) {
        Left_wheel1 =0;
    }
    if (Left_wheel2>= ((100+threshold)/100*l_min)) {
        Left_wheel2 =0;
    }
    if (Left_wheel3>= ((100+threshold)/100*l_min)) {
        Left_wheel3 =0;
    }
    double l_total = Left_wheel1 + Left_wheel2 + Left_wheel3;
    count=3;
    if (Left_wheel1==0){
        count = count-1;
    }
